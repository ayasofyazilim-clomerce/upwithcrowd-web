    ...
    <section className="px-6 py-20">
      <div className="container mx-auto space-y-8 text-center">
        <div className="mx-auto max-w-3xl space-y-4">
          <h2 className="text-3xl font-bold md:text-5xl">Türkiye&apos;nin Kitle Fonlama Platformu</h2>
          <h3 className="text-lg">
            Yaratıcı fikirlerinizi hayata geçirmek için ihtiyaç duyduğunuz fonu Türkiye&apos;nin güvenilir kitle fonlama
            platformunda toplayın.
          </h3>
        </div>
        <div className="flex w-full flex-col items-center justify-center gap-16 md:flex-row">
          <Missions missionsData={missions} />
          <div className="relative h-full">
            <Image alt="Kitle Fonlama Görseli" height={380} src="https://placehold.co/630x380" width={630} />
          </div>
        </div>
      </div>
    </section>
