            ...
            <div className="flex flex-col items-center gap-4 md:flex-row md:items-start">
              <div className="mb-4 text-center md:text-left">
                ...
                <p className="mb-4 max-w-2xl">
                  John has been working on sustainable water solutions for over a decade. His passion for clean water
                  access drives him to create innovative, eco-friendly technologies. With a background in environmental
                  engineering and years of field experience, John has developed multiple patented water purification
                  systems that are now used in various parts of the world.
                </p>
              </div>
            </div>
          </CardContent>
